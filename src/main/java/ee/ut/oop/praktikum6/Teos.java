...
public abstract class Teos implements Comparable<Teos> {
	...
	public Teos(String teoseKirjeldus, String teoseTähis,
	            String laenutajaNimi, int päevadeArv) {
	...
	public void arvutaViivis(Kontrollija kontrollija) {
		if (päevadeArv > laenutesaeg()) {
			double viivis = (päevadeArv - laenutesaeg()) * päevaneViivis();
